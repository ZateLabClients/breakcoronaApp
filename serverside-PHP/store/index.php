...
<body>
  ...
  <div style="margin-top:46px;" class="header"><a href="shop/login.html" style="text-decoration: none !important;">If you are a Shopkeeper please signup/login to add your service by clicking here</a></div>
  ...
  <?php
    require 'connect.php';
    $sql="Select id,name,phone,s_name,location,w_hrs From stores where status='active'";
